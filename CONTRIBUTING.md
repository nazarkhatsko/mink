...
Add `manual/drivers/mydriver.md` (config/options/output fields, an example) and list it in `manual/drivers/README.md` — this is the only source for `mink doc drivers mydriver`.
