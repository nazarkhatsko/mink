...
Add `doc/drivers/mydriver.md` (config/options/output fields, an example) and list it in `doc/drivers/README.md` — this is the only source for `mink doc drivers mydriver`.
